...
namespace DataMigrationWebTools.Models.DataModel
{
    ...
    public partial class MultiUserDBEntities : DbContext
    {
        ...
        public virtual DbSet<vw_aum_ios> vw_aum_ios { get; set; }
        public virtual DbSet<vw_endors_ivl> vw_endors_ivl { get; set; }
        public virtual DbSet<vw_ipp_all> vw_ipp_all { get; set; }
        public virtual DbSet<vw_polis> vw_polis { get; set; }
        public virtual DbSet<vw_polisipp> vw_polisipp { get; set; }
        public virtual DbSet<vw_polisippc> vw_polisippc { get; set; }
    }
}
