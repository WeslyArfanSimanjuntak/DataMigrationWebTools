...
namespace DataMigrationConsoleTools.DataModels
{
    ...
    public partial class ISL_APP_STG_HDR
    {
        public int N_STAGING_HDR_ID { get; set; }
        public string C_FILENAME { get; set; }
        public Nullable<int> N_TOTAL_CUST { get; set; }
        public Nullable<double> N_AMOUNT { get; set; }
        public string C_STATUS { get; set; }
        public string C_PROCESS_STATUS { get; set; }
        public string C_NOTES { get; set; }
        public System.DateTime D_EFFECTIVE_POLIS { get; set; }
