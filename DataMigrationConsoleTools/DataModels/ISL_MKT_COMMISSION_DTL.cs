...
namespace DataMigrationConsoleTools.DataModels
{
    ...
    public partial class ISL_MKT_COMMISSION_DTL
    {
        public int N_COMMISSION_DTL_ID { get; set; }
        public int N_COMMISSION_HDR_ID { get; set; }
        public int N_POLICY_PCF_ID { get; set; }
        public string C_STATUS { get; set; }
        public double N_GROSS_AMOUNT { get; set; }
        public double N_TAX_AMOUNT { get; set; }
